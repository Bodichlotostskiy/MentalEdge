...
{
    public class CalendarViewModel : BasePageViewModel, INotifyPropertyChanged
    {
        ...
        public CalendarViewModel() : base()
        {
            ...
            Events = new EventCollection
            {
                ...
                [DateTime.Now.AddDays(-6)] = new DayEventCollection<AdvancedEventModel>(Color.Green, Color.Green)
                {
            ...
            Events.Add(DateTime.Now.AddDays(-2), new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool")) { EventIndicatorColor = Color.Green, EventIndicatorSelectedColor = Color.Red });
            Events.Add(DateTime.Now.AddDays(-4), new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool")) { EventIndicatorColor = Color.Red, EventIndicatorSelectedColor = Color.Red });
            Events.Add(DateTime.Now.AddDays(-5), new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool")) { EventIndicatorColor = Color.Red, EventIndicatorSelectedColor = Color.Green });
